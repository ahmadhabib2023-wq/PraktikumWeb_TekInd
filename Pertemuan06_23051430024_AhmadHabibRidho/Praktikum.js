...
btnStart.addEventListener("click", function () {
  // Ubah UI Status
  statusIndicator.className = "alert alert-success"; // Ganti class Bootstrap (Hijau) teksStatus.innerText = 'RUNNING';
...
// Event Input (Validasi Real-time)
...
inputRPM.addEventListener("input", function () {
  ...
  if (val > 2000) {
    pesanError.classList.remove("d-none"); // tampilkan error
    this.classList.add("is-invalid"); // border merah
  } else {
    pesanError.classList.add("d-none"); // sembunyikan error
